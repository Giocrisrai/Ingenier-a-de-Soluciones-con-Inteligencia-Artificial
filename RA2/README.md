...
Se trabaja con varios runtimes en paralelo — LangGraph (camino actual), LangChain clásico (`AgentExecutor`) y CrewAI — más function calling, APIs, bases de datos y protocolos como MCP. El punto no es memorizar una librería: es **armar criterio**. El enfoque práctico permite que los estudiantes construyan agentes funcionales que resuelvan tareas cognitivas complejas, fortaleciendo su capacidad para diseñar flujos de trabajo automatizados y documentar arquitecturas de sistemas inteligentes.
...
- Act 2.4 - Documentación Técnica y Diseño de Arquitectura (`IL2.4/0-arquitectura-ra2.md`)
